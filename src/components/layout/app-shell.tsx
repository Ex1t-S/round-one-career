...
const styles = StyleSheet.create({
  ...
  actionDock: { minHeight: 72, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', gap: 14, backgroundColor: Colors.bgRaised, borderWidth: 1, paddingHorizontal: 16, paddingVertical: 12, marginBottom: Spacing.lg }, actionDockCopy: { flex: 1, minWidth: 220 }, actionDockEyebrow: { fontFamily: Fonts.mono, fontSize: 8, fontWeight: '900', letterSpacing: 1.2 }, actionDockTitle: { color: Colors.textSoft, fontFamily: Fonts.sans, fontSize: 12, fontWeight: '800', marginTop: 5 }, actionDockButton: { minHeight: 40, justifyContent: 'center', paddingHorizontal: 15, borderWidth: 1, borderRadius: Radius.sm }, actionDockButtonText: { color: Colors.black, fontFamily: Fonts.mono, fontSize: 9, fontWeight: '900', letterSpacing: 0.7, textTransform: 'uppercase' }, actionDockPressed: { opacity: 0.72 },
