...
const styles = StyleSheet.create({
  card: { flex: 1, minWidth: 280, backgroundColor: Colors.panel, borderWidth: 1, borderColor: Colors.line, padding: 14 }, header: { minHeight: 42, marginBottom: 6 }, title: { color: Colors.text, fontSize: 12, fontWeight: '900' }, subtitle: { color: Colors.muted, fontFamily: Fonts.mono, fontSize: 8, marginTop: 4 }, chart: { minHeight: 190, overflow: 'hidden' }, empty: { height: 190, alignItems: 'center', justifyContent: 'center' }, emptyMark: { color: Colors.lineStrong, fontSize: 35 }, emptyText: { color: Colors.muted, fontFamily: Fonts.mono, fontSize: 8, marginTop: 8 }, tooltip: { position: 'absolute', top: 4, width: 112, backgroundColor: Colors.bg, borderWidth: 1, borderColor: Colors.lineStrong, padding: 7 }, tooltipLabel: { color: Colors.muted, fontFamily: Fonts.mono, fontSize: 7 }, tooltipValue: { color: Colors.text, fontSize: 13, fontWeight: '900', marginTop: 2 }, radar: { alignItems: 'center' },
});
