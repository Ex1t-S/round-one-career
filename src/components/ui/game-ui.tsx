...
const styles = StyleSheet.create({
  ...
  badge: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 5, borderRadius: Radius.sm, borderWidth: 1, borderColor: Colors.line }, badgeText: { fontFamily: Fonts.mono, fontSize: 8, fontWeight: '800', letterSpacing: 0.7, textTransform: 'uppercase' },
  ...
  metric: { minWidth: 100, flex: 1 }, metricLabel: { color: Colors.muted, fontFamily: Fonts.mono, fontSize: 8, fontWeight: '800', letterSpacing: 1, textTransform: 'uppercase' }, metricValue: { fontFamily: Fonts.sans, fontSize: 24, lineHeight: 29, fontWeight: '800', marginTop: 7, letterSpacing: -0.5 }, metricDetail: { color: Colors.muted, fontFamily: Fonts.sans, fontSize: 10, marginTop: 3 },
  ...
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', gap: Spacing.md, marginTop: 3, marginBottom: Spacing.lg }, sectionHeaderCopy: { flex: 1 }, sectionTitle: { color: Colors.text, fontFamily: Fonts.sans, fontSize: 21, fontWeight: '800', letterSpacing: -0.35 },
