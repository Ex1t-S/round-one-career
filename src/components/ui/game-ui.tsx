...
const styles = StyleSheet.create({
  ...
  badge: { alignSelf: 'flex-start', paddingHorizontal: 9, paddingVertical: 6, borderRadius: Radius.sm, borderWidth: 1, borderColor: Colors.line }, badgeText: { fontFamily: Fonts.sans, fontSize: 11, lineHeight: 15, fontWeight: '800', letterSpacing: 0.35, textTransform: 'uppercase' },
  ...
  buttonCompact: { minHeight: 40, paddingVertical: 8, paddingHorizontal: 13 }, buttonText: { color: Colors.text, fontFamily: Fonts.sans, fontSize: 13, lineHeight: 18, fontWeight: '800', letterSpacing: 0.25 }, buttonTextDark: { color: Colors.black }, buttonTextDanger: { color: Colors.red },
  disabled: { opacity: 0.35 }, pressed: { opacity: 0.72 },
  metric: { minWidth: 100, flex: 1 }, metricLabel: { color: Colors.muted, fontFamily: Fonts.sans, fontSize: 11, lineHeight: 15, fontWeight: '800', letterSpacing: 0.45, textTransform: 'uppercase' }, metricValue: { fontFamily: Fonts.sans, fontSize: 25, lineHeight: 30, fontWeight: '800', marginTop: 7, letterSpacing: -0.5 }, metricDetail: { color: Colors.muted, fontFamily: Fonts.sans, fontSize: 12, lineHeight: 17, marginTop: 4 },
  ...
  sectionHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end', gap: Spacing.md, marginTop: 3, marginBottom: Spacing.lg }, sectionHeaderCopy: { flex: 1 }, sectionTitle: { color: Colors.text, fontFamily: Fonts.sans, fontSize: 25, lineHeight: 31, fontWeight: '800', letterSpacing: -0.35 },
